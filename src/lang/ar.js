export default {
    ...
    reminders: {
        ...
        open_app: "قال الله تعالى 'فاذكروني أذكركم واشكروا لي وال تكفرون'، فلا تنس أن تقرأ القرآن اليوم",
        khatema: "انت قرأت :read صفحة في الخاتمة الحالية و متبقي :remaining صفحة. "
    },
    setting: "اﻷعدادات",
    login: "تسجيل الدخول",
    logout: "تسجيل الخروج",
