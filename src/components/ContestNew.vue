    ...
    export default {
        ...
        data() {
            return {
                ...
                suras: [],
                selected_suras: [],
                fetched_suras: ["الفاتحه", "البقرة", "ال عمران", "الفاتحه", "البقرة", "ال عمران", "الفاتحه", "البقرة",
                    "ال عمران", "الفاتحه", "البقرة", "ال عمران", "الفاتحه", "البقرة", "ال عمران", "الفاتحه", "البقرة", "ال عمران"]
            };
        },
        mounted() {
